...
{
	class Exile_Container_Safe_Small { max = 9999999; };	
};
...
class CfgTerritories
{
	...
	prices[] = 
	{
		...
		{5000,					15,			300 					}, // Level 1
		{10000,					30,			300 					}, // Level 2 
		{15000,					45,			300					}, // Level 3
		{20000,					60,			300					}, // Level 4
		{25000,					75,			300					}, // Level 5
		{30000,					90,			300					}, // Level 6
		{35000,					105,		300					}, // Level 7
		{40000,					120,		300					}, // Level 8
		{45000,					135,		300					}, // Level 9
...
class CfgXM8 
{
	...
	extraApps[] = {"ExAd_VG","ExAd_CHVD","ExAd_JX","ExAd_Bike","ExAd_Quad","ExAd_SB",""};
...
{
    textureNoShortcut = "d2k\UnitScanner\icons\logo.paa";
    text = "Unit Scanner";
    onButtonClick = "closeDialog 1; createDialog ""d2kUnitScanner"";";
    resource = "";
};
